...
function Solutions() {
  ...
  return (
    <div className="font-manrope mb-16 py-4 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto ">
        ...
        <div className="flex justify-center">
          <Link aria-label="view more"
            to="/industries"
            className="inline-flex items-center justify-center py-4 px-8  border border-blue-900 bg-blue-900 text-white font-semibold rounded-md text-lg transition duration-200 hover:bg-blue-900/90 hover:shadow-md hover:shadow-bloo/30"
          >
