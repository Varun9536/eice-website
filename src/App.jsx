...
import Pos from "./Services/Pos.jsx";
import RoomBooking from "./Services/RoomBooking.jsx";
import AccountAndFinance from "./Services/AccountAndFinance.jsx";
import BanquetAndBilling from "./Services/BanquetAndBilling.jsx";
import Payroll from "./Services/Payroll.jsx";
import FoodCostAnalysis from "./Services/FoodCostAnalysis.jsx";
import UserStoreAndInventary from "./Services/UserStoreAndInventary.jsx";
import PurchaseAndVendorPortal from "./Services/PurchaseAndVendorPortal.jsx";
import Hospitality from "./Servcomps/Hospitality.jsx";
import EmployeePortal from "./Services/EmployeePortal.jsx";
import MemberPortal from "./Services/MemberPortal.jsx";
  ...
  return (
    <BrowserRouter>
      ...
      <Routes>
        ...
        <Route path="/hospitality" element={<HospitalityPage />} ></Route>
        <Route path="/pos" element={<PosPage />}></Route>
        <Route path="/roombooking" element={<RoomBookingPage />}></Route>
        <Route path="/accountAndFinance" element={<AccountAndFinancePage />} />
        <Route path="/banquetAndBilling" element={<BanquetAndBillingpage />}></Route>
        <Route path="/employeePortal" element={<EmployeePortalPage />}></Route>
        <Route path="/memberPortal" element={<MemberPortalPage />}></Route>
        <Route path="/foodCost" element={<FoodCostAnalysisPage />}></Route>
        <Route path="/payroll" element={<PayRollPage />}></Route>
        <Route path="/purchaseVendorPortal" element={<PurchaseAndVendorPortalPage />}></Route>
        <Route path="/storeAndInventry" element={<UserStoreAndInventaryPage />}></Route>
...
const UserStoreAndInventaryPage = () => {
  return (
    <>
      <UserStoreAndInventary />
      <Footer />
      <Copyright />
    </>
  );
...
const PurchaseAndVendorPortalPage = () => {
  return (
    <>
      <PurchaseAndVendorPortal />
      <Footer />
      <Copyright />
    </>
  );
