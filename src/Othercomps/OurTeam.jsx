  ...
  return (
    <div className="-mt-6 font-manrope">
      <div className="relative w-full 2xl:pt-12 pt-32 pb-12 ">
        ...
        />
        <h1 className="fontsize_2 text-white  text-center  py-16">
          Our Team
        </h1>
      </div>
      <div className="max-w-7xl mx-auto px-4 py-12">
        <div className="text-bloo  text-center  py-2">
          ...
          <p className=" fontsize_4  text-justify text-blackk/60  max-w-5xl mx-auto  py-4   leading-snug">
      ...
      <div className="max-w-7xl mx-auto">
        <div>
          ...
          <p className=" fontsize_4  text-justify text-blackk/60  max-w-5xl mx-auto  py-4  ">
