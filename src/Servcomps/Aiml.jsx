  ...
  ai: [
    {
      ...
      description: "Developement of an Advanced AI Voice Call Assistant: Revolutionizing Customer Interaction and Efficiency",
    ...
    <div>
      ...
      <div className="bg-zinc-50 pb-32 text-justify my-12">
        <div className="relative font-manrope mx-auto sm:max-w-7xl w-screen pt-20">
          ...
          <h2 className="text-blackk fontweight_1  fontsize_2 text-center">
