  ...
  return (
    <div>
        ...
        <div className="relative font-manrope mx-auto sm:max-w-7xl w-screen ">
          ...
          <div className="flex lg:flex-row flex-col px-4 py-20 items-center">
            <div className="w-full">
              <h1 className="text-blackk  font-bold text-3xl sm:text-4xl lg:text-5xl ">
      ...
      <div className="relative font-manrope mx-auto sm:max-w-7xl w-screen py-4">
        ...
        <h2 className="text-blackk  font-bold text-center text-2xl sm:text-3xl mx-auto md:text-3xl lg:text-[32px] max-w-3xl py-1">
      ...
      <div className="bg-zinc-50 pb-32 text-justify my-12">
        <div className="relative font-manrope mx-auto sm:max-w-7xl w-screen pt-20">
          <h1 className="text-bloo font-bold sm:text-3xl text-2xl pb-4 text-center">
            Why Choose EICE
          </h1>
          <h2 className="text-blackk font-bold sm:text-4xl text-2xl sm:leading-tight leading-snug text-center">
            ...
            <div className="grid grid-cols-1 gap-10">
              {[
                ...
                <div key={index} className="flex items-start space-x-8 ">
                  ...
                  <div>
                    <p className="font-medium text-blackk/60 sm:text-xl text-lg">
                      <span className="text-blackk font-bold text-lg pt-1 pb-3 sm:text-xl">
                        {item.title}:{" "}
                      </span>
                      {item.content}
                    </p>
